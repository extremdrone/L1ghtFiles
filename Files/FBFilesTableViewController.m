...
-(void)sortFiles
{
	NSUserDefaults *defaults = [[NSUserDefaults alloc] initWithSuiteName:@"group.com.L1ghtSn0w.Files"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if (fileExists)
	{
		...
		{
			if ([[[NSBundle mainBundle] bundleIdentifier] isEqualToString:@"com.L1ghtSn0w.Files.FilesDocumentProvider"])
			{
